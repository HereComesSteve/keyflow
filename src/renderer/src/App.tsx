...
import { GloveControlPanel } from './components/GloveControlPanel';
...
function App(): React.JSX.Element {
  ...
  // Bluetooth手套接続パネル（ルーティング不要・条件渲染で表示制御）。
  const [isGloveOpen, setIsGloveOpen] = React.useState(false);
